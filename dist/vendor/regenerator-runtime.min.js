 ...
 */ var runtime = (function(a) {
  ...
  function d() {}
  function e() {}
  function f() {} // This is a polyfill for %IteratorPrototype% for environments that
  ...
  function h(a) {
    ...
    function d(a, c) {
      ...
      return (e = // If enqueue has been called before, then we want to wait until
        ...
        e
          ? e.then(
              d, // Avoid propagating failures to Promises returned by later
  ...
  function i(a, b, d) {
    ...
    return function(f, g) {
      ...
      for (d.method = f, d.arg = g; ; ) {
        ...
        var k = c(a, b, d);
        if ('normal' === k.type) {
          if (((e = d.done ? 'completed' : 'suspendedYield'), k.arg === v)) continue;
          return { value: k.arg, done: d.done };
        }
        'throw' === k.type && // Dispatch the exception by looping back around to the
  ...
  function j(a, b) {
    ...
    if ('throw' === e.type) return (b.method = 'throw'), (b.arg = e.arg), (b.delegate = null), v;
    var f = e.arg;
    if (!f)
      return (b.method = 'throw'), (b.arg = new TypeError('iterator result is not an object')), (b.delegate = null), v;
    if (f.done)
      (b[a.resultName] = f.value),
        (b.next = a.nextLoc),
        'return' !== b.method && ((b.method = 'next'), (b.arg = void 0));
    // Re-yield the result returned by the delegate method.
    else return f; // The delegate iterator is finished, so forget it and continue with
    // the outer generator.
    return (b.delegate = null), v;
  ...
  var x = Object.getPrototypeOf,
    y = x && x(x(n([])));
  y && y !== p && q.call(y, s) && (w = y);
  var z = (f.prototype = d.prototype = Object.create(w)); // Regardless of whether this script is executing as a CommonJS module
  // or not, return the runtime object so that we can declare the variable
  // regeneratorRuntime in the outer scope, which allows this module to be
  // injected easily by `bin/regenerator --include-runtime script.js`.
  return (
    (e.prototype = z.constructor = f),
    (f.constructor = e),
    ...
    (a.isGeneratorFunction = function(a) {
      ...
      return (
        !!b &&
        (b === e || // For the native GeneratorFunction constructor, the best we can
    ...
    (a.AsyncIterator = h),
    (a.async = function(c, d, e, f) {
      var g = new h(b(c, d, e, f));
      return a.isGeneratorFunction(d)
        ? g // If outerFn is a generator, return the full iterator.
    ...
    (a.keys = function(a) {
      var b = [];
      for (var c in a) b.push(c); // Rather than returning an object with a next method, we keep
    ...
    (m.prototype = {
      ...
      reset: function(a) {
        if (
          ...
          for (var b in this) // Not sure about the optimal order of these conditions:
      ...
      abrupt: function(a, b) {
        for (var c, d = this.tryEntries.length - 1; 0 <= d; --d)
          if (
            ((c = this.tryEntries[d]), c.tryLoc <= this.prev && q.call(c, 'finallyLoc') && this.prev < c.finallyLoc)
          ) {
            var e = c;
            break;
          }
        ...
        return (
          (f.type = a), (f.arg = b), e ? ((this.method = 'next'), (this.next = e.finallyLoc), v) : this.complete(f)
        );
      },
      ...
      finish: function(a) {
        for (var b, c = this.tryEntries.length - 1; 0 <= c; --c)
          if (((b = this.tryEntries[c]), b.finallyLoc === a)) return this.complete(b.completion, b.afterLoc), l(b), v;
      },
      catch: function(a) {
        for (var b, c = this.tryEntries.length - 1; 0 <= c; --c)
