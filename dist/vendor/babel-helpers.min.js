(function(a) {
  ...
  function i(a) {
    return (
      (r.getPrototypeOf = i = Object.setPrototypeOf
  ...
  function m(a) {
    ...
    return (
      (r.wrapNativeSuper = m = function(a) {
        function c() {
  ...
  (r.typeof = b),
    ...
    (r.AsyncGenerator = c),
    (r.wrapAsyncGenerator = function(a) {
      return function() {
    ...
    (r.defineEnumerableProperties = f),
    (r.defaults = function(a, b) {
    ...
    (r.setPrototypeOf = j),
    (r.construct = l),
    (r.isNativeFunction = function(a) {
      return -1 !== Function.toString.call(a).indexOf('[native code]');
    }),
    (r.wrapNativeSuper = m),
    (r.instanceof = function(a, b) {
      ...
      if (null != a)
        for (var c in a)
          if (Object.prototype.hasOwnProperty.call(a, c)) {
            var d =
              Object.defineProperty && Object.getOwnPropertyDescriptor ? Object.getOwnPropertyDescriptor(a, c) : {};
    ...
    (r.objectWithoutPropertiesLoose = function(a, b) {
      if (null == a) return {};
      var c,
        d,
        e = {},
    ...
    (r.get = n),
    (r.set = p),
    (r.taggedTemplateLiteral = function(a, b) {
    ...
    (r.iterableToArray = q),
    (r.iterableToArrayLimit = function(a, b) {
      var c = [],
        d = !0,
        e = !1,
        f = void 0;
